    ...
    <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql ="UPDATE employee SET name='$name', email='$email',". "mobile='$mobile',address='$address',job_name='$job_name',department='$dept',joining_date='$j_date',status='$status',employee_id='$eid',schedule_id='$sid' WHERE id=$id1";
